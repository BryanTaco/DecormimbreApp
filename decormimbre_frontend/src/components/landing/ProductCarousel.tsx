...
const PRODUCTS = [
  {
    ...
    price: 'Desde $185',
    src: 'https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=900&q=85&auto=format&fit=crop&crop=center',
    bg: '#7B5840',
  },
  {
    name: 'Sofá Serena',
    ...
    price: 'Desde $620',
    src: 'https://images.unsplash.com/photo-1593062096033-9a26b09da705?w=900&q=85&auto=format&fit=crop&crop=center',
    bg: '#4A6741',
  },
  {
    name: 'Mesa Canasto',
    collection: 'Colección Raíz',
    description: 'Diseño orgánico inspirado en el entrelazado de raíces del bosque andino. Mimbre y vidrio templado en armonía.',
    material: 'Mimbre & Vidrio',
    price: 'Desde $290',
    src: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&q=85&auto=format&fit=crop&crop=center',
    bg: '#8B6B52',
  },
  {
    name: 'Set Exterior',
    ...
    price: 'Desde $890',
    src: 'https://images.unsplash.com/photo-1629079447777-1e605162dc8d?w=900&q=85&auto=format&fit=crop&crop=center',
    bg: '#5E7A5C',
  },
]
...
function CardItem({
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          padding: isCenter ? '20px 22px 22px' : '14px 16px 16px',
...
export default function ProductCarousel() {
  ...
  return (
    ...
    >
      ...
      {/* Ghost text DECORMIMBRE — detrás de todo */}
      <div
        style={{
          position: 'absolute',
          inset: 0,
      ...
      <div style={{ position: 'relative', height: '100vh', maxHeight: '720px', minHeight: '560px' }}>
        {/* Cards */}
        <div style={{ position: 'absolute', inset: 0, zIndex: 10 }}>
          {PRODUCTS.map((product, idx) => (
            <CardItem key={idx} product={product} role={roles[idx]} />
          ))}
        </div>
