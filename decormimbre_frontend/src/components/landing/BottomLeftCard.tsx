  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <span className="text-2xl md:text-3xl font-normal text-[rgba(92,64,51,0.9)] tracking-tight">
          1.2K
        </span>
        <span className="text-[10px] md:text-[12px] font-normal text-[rgba(92,64,51,0.6)] uppercase tracking-wider">
      ...
      >
        <div className="bg-[rgba(92,64,51,0.1)] p-1 rounded-full flex items-center justify-center">
          <ArrowUpRight className="w-4 h-4 text-[rgba(92,64,51,0.9)]" />
        </div>
        <span className="text-[14px] font-normal text-[rgba(92,64,51,0.9)]">Ver Catálogo</span>
      </motion.button>
    </motion.div>
  )
}
